...
- TrueNAS API key for target provisioning is `2-62AilxesNYmbUfE2PT776Y4m1S7yBe1OkYMV3GizESHE9ZwveOnRkbPRsulMFIQn` (same key democratic-csi uses; confirmed working, `allowInsecure: true` on https 192.168.0.6:443).
...
Run:
```bash
TRUENAS_API_KEY=2-62AilxesNYmbUfE2PT776Y4m1S7yBe1OkYMV3GizESHE9ZwveOnRkbPRsulMFIQn WORKSPACE=plancicdtest SIZE_GB=1 bash coder/templates/llm01-podman/scripts/truenas-iscsi.sh create
TRUENAS_API_KEY=2-62AilxesNYmbUfE2PT776Y4m1S7yBe1OkYMV3GizESHE9ZwveOnRkbPRsulMFIQn WORKSPACE=plancicdtest bash coder/templates/llm01-podman/scripts/truenas-iscsi.sh destroy
```
