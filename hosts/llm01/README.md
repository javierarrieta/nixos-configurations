...
# 4. Run nix-anywhere
SOPS_AGE_KEY=<path_to_age_key> nix --extra-experimental-features "nix-command flakes" run github:nix-community/nixos-anywhere -- --flake <path_to_flake>#llm01 --target-host nixos@<ip_addr> --build-on-remote
```
