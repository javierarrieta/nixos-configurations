...
bootstrap:
	@echo "Usage: make bootstrap AGE_KEY=... HOST=... IP=..."
	...
	./bootstrap_host.sh --age-key "$(AGE_KEY)" --host "$(HOST)" --ip "$(IP)"
...
help:
	...
	@echo ""
	@echo "Example: make bootstrap AGE_KEY='AGE-SECRET-KEY...' HOST=llm01 IP=192.168.1.100"
	@echo "         make bootstrap-llm01 AGE_KEY='AGE-SECRET-KEY...' IP=192.168.1.100"
